...
from torch.utils.data import SubsetRandomSampler, SequentialSampler, RandomSampler

dataset = os.getcwd() + "/Dataset_downscaled_540p"
...
plt.plot(epoch_count, torch.tensor(val_loss_values), label="Val loss")
...
video_path = "/content/gdrive/MyDrive/Dataset/Bad/000002.mp4"
...
model_v1 = torch.hub.load('facebookresearch/pytorchvideo', 'slow_r50', pretrained=True)

model_v1.load_state_dict(torch.load(f=model_save_path))
